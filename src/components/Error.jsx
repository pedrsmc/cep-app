...
export function Error({ errorMessage, setIsOpen }) {
    ...
    return (
        <div className="h-[70px] flex justify-center items-center fixed bottom-14 text-white shadow-lg">
            ...
            <button onClick={() => setIsOpen(false)} className="h-[100%] bg-red-900 p-5 rounded-r-sm"><FontAwesomeIcon icon={faX} /></button>
        </div>
    )
}